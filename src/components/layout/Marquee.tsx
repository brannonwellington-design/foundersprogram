...
export function Marquee() {
  ...
  return (
    <MaskMedia
      reveal="load"
      revealDelay={LOAD.marquee}
      className="w-full"
      innerClassName="w-full bg-surface-brand-primary py-1 select-none"
    >
      <div ref={trackRef} className="flex w-max max-w-none will-change-transform">
